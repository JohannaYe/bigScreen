                    ...
                    series: [
                        {
                            ...
                            data: [
                                { value: this.$store.state.screen.countsByGender[0], name: '公牛' },
                                { value: this.$store.state.screen.countsByGender[1], name: '母牛' },
                                { value: this.$store.state.screen.countsByGender[2], name: '阉割牛' },
                                // { value: 12, name: '0-1岁' },
