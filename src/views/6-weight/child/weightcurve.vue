<template>
    <div style="width: 100%;height: 100%"  id="ma">
...
<script>
    ...
    let option = {
        ...
        tooltip: {
            ...
            formatter: (p) => {
                console.log(p)
                let dom = `<div style="color:#fff;position: relative;">
    ...
    export default {
        ...
        methods: {
            //初始化echarts
            echartsInit() {
                this.$echarts.init(document.getElementById("ma")).setOption(option);
